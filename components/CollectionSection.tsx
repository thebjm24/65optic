      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {frames.map((frame, index) => (
            <div
              key={index}
              className="group relative h-80 md:h-96 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all duration-300"
            >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center">
                ...
                <button className="px-6 py-2 bg-accent text-black font-semibold rounded-lg hover:bg-accent/90 transition-colors">
                  View
                </button>
              </div>
            </div>
        ...
        <div className="flex justify-center mt-16">
          <button className="group px-8 py-4 bg-accent text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-accent/50 transition-all flex items-center gap-2">
            {discoverBtn}
